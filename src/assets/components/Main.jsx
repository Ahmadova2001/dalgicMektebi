    ...
    <main>
      ...
      <section className="py-20 bg-[#122241] text-white flex flex-col justify-center items-center font-montserrat">
        <div className="text-center px-6 max-w-4xl">
          ...
          <button>
            <Link to="/about" className="bg-white text-[#122241] font-black py-3 px-10 rounded-full text-md shadow-2xl hover:bg-[#87CEFA] transition-all duration-300 uppercase">DAHA ÇOX</Link>
          </button>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 px-6">
          <div className="relative h-[700px] overflow-hidden group cursor-pointer">
            ...
            <div className="relative h-full flex flex-col justify-end p-10 text-white z-10">
              ...
              <button>
                <Link to="/services" className="bg-white text-black font-bold py-3 px-10 rounded-full w-fit hover:bg-[#87CEFA] transition-colors">Yer ayır</Link>
              </button>
            </div>
          </div>
          <div className="relative h-[700px] overflow-hidden group cursor-pointer">
      ...
      <section className="relative w-full h-[500px] flex flex-col justify-center items-center text-white bg-fixed bg-cover bg-center" style={{ backgroundImage: `url(${turtle})` }}>
        ...
        <button className='mt-15'>
          <Link to="/services" className="bg-white text-black font-bold py-3 px-10 rounded-full w-fit hover:bg-[#87CEFA] transition-colors">Yatırım et</Link>
        </button>
      </section>
      <section className='bg-blue-950 py-20'>
